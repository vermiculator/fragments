...
* AnyType is promising in lots of ways
  ...
  * significant contributors can 'join' somehow - see [https://blog.anytype.io/our-open-philosophy/](https://blog.anytype.io/our-open-philosophy/)
...
the anysync protocol is based on CRDTs, i read about these in undergrad - [Conflict-free replicated data types](/mdx/earth/conflict-free-replicated-data-types), promising
