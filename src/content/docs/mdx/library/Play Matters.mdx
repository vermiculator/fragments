...
author:
  - Sicart, M
summary: why is play important and how does it connect to the rest of life -
  from first chapter 'Play Is'
kind: books
...
[https://ebookcentral.proquest.com/lib/ual/detail.action?docID=5348705](https://ebookcentral.proquest.com/lib/ual/detail.action?docID=5348705)
...
* "Initially a spam bot, then a piece of automatic found art, and finally a piece of performance art, *Horse\_ebooks* is the perfect example of carnivalesque—dangerous play and playfulness in this age of computing machinery."  [⤴️](https://read.readwise.io/read/01jhz6vygzr4w5xte3snrye7m6)
