...
export const collections = {
	...
	thesis: defineCollection({
		loader: glob({ pattern: ['**/*.md', '**/*.mdx'], base: "./src/content/docs/mdx/works/thesis" }),
		schema: generalSchema
	}),
	metaThesis: defineCollection({
		loader: glob({ pattern: ['**/*.md', '**/*.mdx'], base: "./src/content/docs/mdx/works/thesis/meta-thesis" }),
		schema: generalSchema
	}),
